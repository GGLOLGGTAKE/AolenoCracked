...
Tab:AddLabel("--------- Version 3 News ---------")
Tab:AddLabel("[ + ] Added Script Games Tab")
Tab:AddLabel("[ + ] Added Script Hub Tab")
Tab:AddLabel("[ + ] Added Executor UI Tab")
Tab:AddLabel("[ + ] Added RTX Script ( Low To Ultra ) In Misc Tab")
Tab:AddLabel("[ + ] Added FE Script In Misc Tab")
Tab:AddLabel("[ + ] Added Misc Script In Misc Tab")
Tab:AddLabel("[ + ] Christmas Decorations ")
